...
//CreateImage
void SGvk_Device_Create_Image(VkPhysicalDevice& phys,VkDevice& device,uint32_t width, uint32_t height, VkFormat format, 
    VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, 
    VkImage& image, VkDeviceMemory& imageMemory);


//Append
void SGvk_Device_Create_TransitionImageLayout(VkQueue& endque,VkDevice& device,VkCommandPool& commandPool,VkImage& image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout);
